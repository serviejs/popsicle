        ...
        return attachCookies(url)
            ...
            return new Promise(function (resolve, reject) {
                ...
                function response(incomingMessage) {
                    var headersRaw = incomingMessage.headers, rawHeaders = incomingMessage.rawHeaders, statusRaw = incomingMessage.statusCode, statusTextRaw = incomingMessage.statusMessage;
                    var headers = headersRaw;
                    var status = statusRaw;
                    var statusText = statusTextRaw;
...
function getAttachCookies(request, options) {
    ...
    return function (url) {
        return new Promise(function (resolve, reject) {
            ...
            (_a = options.jar) === null || _a === void 0 ? void 0 : _a.getCookieString(url, function (err, jarCookieString) {
                if (err) {
                    return reject(err);
                }
                if (jarCookieString) {
